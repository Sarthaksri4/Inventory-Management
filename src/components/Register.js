                ...
                <div className="forms_data">
                    ...
                    <form>
                        <div className="forms_input">
                            ...
                            <input type="text" onChange={setVal}  name="name" id="name" placeholder='Enter Your Name' />
                        </div>
                        <div className="forms_input">
                        ...
                        <div className="forms_input">
                            ...
                            <div className="two">
                                <input type="password"  onChange={setVal} name="confirmpassword" id="confirmpassword" placeholder='Confirm password' />
                            </div>
                        </div>
